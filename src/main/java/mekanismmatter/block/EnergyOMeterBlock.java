...
public class EnergyOMeterBlock extends MekanismmatterModElements.ModElement {
	@ObjectHolder("mekanismmatter:energy_o_meter")
	public static final Block block = null;
	public EnergyOMeterBlock(MekanismmatterModElements instance) {
		super(instance, 163);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("energy_o_meter");
		}
