...
public class TriniumBlockBlock extends MekanismmatterModElements.ModElement {
	@ObjectHolder("mekanismmatter:trinium_block")
	public static final Block block = null;
	public TriniumBlockBlock(MekanismmatterModElements instance) {
		super(instance, 16);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.GROUND).hardnessAndResistance(5f, 8000f).setLightLevel(s -> 0)
					.harvestLevel(4).harvestTool(ToolType.PICKAXE).setRequiresTool());
			setRegistryName("trinium_block");
		}
