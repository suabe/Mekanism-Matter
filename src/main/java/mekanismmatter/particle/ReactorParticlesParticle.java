...
package mekanismmatter.particle;
...
public class ReactorParticlesParticle {
	...
	public static void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("reactor_particles"));
	}
