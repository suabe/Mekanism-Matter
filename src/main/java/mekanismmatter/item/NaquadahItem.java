...
public class NaquadahItem extends MekanismmatterModElements.ModElement {
	@ObjectHolder("mekanismmatter:naquadah")
	public static final Item block = null;
	public NaquadahItem(MekanismmatterModElements instance) {
		super(instance, 18);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A77Just because i'm watching Sg - Sg1 rightnow"));
		}
	}
}
