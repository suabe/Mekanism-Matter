...
public class ScarpItem extends MekanismmatterModElements.ModElement {
	@ObjectHolder("mekanismmatter:scarp")
	public static final Item block = null;
	public ScarpItem(MekanismmatterModElements instance) {
		super(instance, 9);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A77Modifier: 1,35x"));
		}
	}
}
