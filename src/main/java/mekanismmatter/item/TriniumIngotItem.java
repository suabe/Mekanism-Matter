...
public class TriniumIngotItem extends MekanismmatterModElements.ModElement {
	@ObjectHolder("mekanismmatter:trinium_ingot")
	public static final Item block = null;
	public TriniumIngotItem(MekanismmatterModElements instance) {
		super(instance, 15);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A77An extremly conductive metall"));
		}
	}
}
