...
@OnlyIn(Dist.CLIENT)
public class ArcFurnaceGUINewGuiWindow extends ContainerScreen<ArcFurnaceGUINewGui.GuiContainerMod> {
	private World world;
	private int x, y, z;
	private PlayerEntity entity;
	public ArcFurnaceGUINewGuiWindow(ArcFurnaceGUINewGui.GuiContainerMod container, PlayerInventory inventory, ITextComponent text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("mekanismmatter:textures/arc_furnace_gui_new.png");
	@Override
	...
	protected void drawGuiContainerBackgroundLayer(MatrixStack ms, float partialTicks, int gx, int gy) {
		...
		this.blit(ms, this.guiLeft + 6, this.guiTop + 15, 0, 0, 18, 18, 18, 18);
		Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("mekanismmatter:textures/extra.png"));
		this.blit(ms, this.guiLeft + 6, this.guiTop + 34, 0, 0, 18, 18, 18, 18);
		Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("mekanismmatter:textures/extra.png"));
		this.blit(ms, this.guiLeft + 6, this.guiTop + 53, 0, 0, 18, 18, 18, 18);
		Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("mekanismmatter:textures/bar_long.png"));
		this.blit(ms, this.guiLeft + 69, this.guiTop + 38, 0, 0, 34, 9, 34, 9);
		...
		}.getValue(world, new BlockPos((int) x, (int) y, (int) z), "smeltingtime")) / 31.25);
		...
		this.blit(ms, this.guiLeft + 70, this.guiTop + 39, 0, 0, progress1, 7, progress1, 7);
		...
		}.getValue(world, new BlockPos((int) x, (int) y, (int) z), "temp")) / 77.58);
		int temp1 = 58 - (int)temp;
		...
		this.blit(ms, this.guiLeft + 156, this.guiTop + 13, 0, 0, 6, temp1, 6, temp1);
		Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("mekanismmatter:textures/input.png"));
		this.blit(ms, this.guiLeft + 42, this.guiTop + 22, 0, 0, 18, 18, 18, 18);
		Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("mekanismmatter:textures/input_2.png"));
		this.blit(ms, this.guiLeft + 42, this.guiTop + 46, 0, 0, 18, 18, 18, 18);
		Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("mekanismmatter:textures/output.png"));
		this.blit(ms, this.guiLeft + 114, this.guiTop + 22, 0, 0, 18, 18, 18, 18);
		Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("mekanismmatter:textures/output_2.png"));
		this.blit(ms, this.guiLeft + 114, this.guiTop + 46, 0, 0, 18, 18, 18, 18);
	...
	protected void drawGuiContainerForegroundLayer(MatrixStack ms, int mouseX, int mouseY) {
		this.font.drawString(ms, "Arc Furnace", 59, 4, -12829636);
	}
