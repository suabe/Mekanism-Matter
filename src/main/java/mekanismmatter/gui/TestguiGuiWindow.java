...
public class TestguiGuiWindow extends ContainerScreen<TestguiGui.GuiContainerMod> {
	...
	private static final ResourceLocation texture = new ResourceLocation("mekanismmatter:textures/testgui.png");
	@Override
	...
	protected void drawGuiContainerBackgroundLayer(MatrixStack ms, float partialTicks, int gx, int gy) {
		...
		this.blit(ms, this.guiLeft + 6, this.guiTop + 36, 0, 0, 18, 18, 18, 18);
