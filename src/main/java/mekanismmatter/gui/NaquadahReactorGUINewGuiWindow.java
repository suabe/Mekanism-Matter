...
@OnlyIn(Dist.CLIENT)
public class NaquadahReactorGUINewGuiWindow extends ContainerScreen<NaquadahReactorGUINewGui.GuiContainerMod> {
	private World world;
	private int x, y, z;
	private PlayerEntity entity;
	public NaquadahReactorGUINewGuiWindow(NaquadahReactorGUINewGui.GuiContainerMod container, PlayerInventory inventory, ITextComponent text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("mekanismmatter:textures/naquadah_reactor_gui_new.png");
	@Override
	...
	protected void drawGuiContainerBackgroundLayer(MatrixStack ms, float partialTicks, int gx, int gy) {
		...
		Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("mekanismmatter:textures/reactor_input_frame.png"));
		this.blit(ms, this.guiLeft + 31, this.guiTop + 27, 0, 0, 112, 32, 112, 32);
		...
		}.getValue(world, new BlockPos((int) x, (int) y, (int) z), "efficiencyoutput3")) / 1724.13);
	...
	protected void drawGuiContainerForegroundLayer(MatrixStack ms, int mouseX, int mouseY) {
		...
		}.getValue(new BlockPos((int) x, (int) y, (int) z), "outputgui")) + "", 39, 62, -12829636);
		this.font.drawString(ms, "Naquadah Reactor", 47, 4, -12829636);
	}
